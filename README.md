...
- 🎯 **Auto-Attack Combat System**: ปืนกลตรวจจับและยิงกระสุนใส่มอนสเตอร์ที่ใกล้ที่สุดอัตโนมัติ (รองรับ Multi-shot, Bullet Pierce, Attack Speed)
...
2. โคลน Repository นี้:
   ...
   `
3. เปิด Godot Engine แล้วกด **Import** -> เลือกไฟล์ 
